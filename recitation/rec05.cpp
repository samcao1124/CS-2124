...
int main() {
    ...
    p = &x; //"p points to x
    // task 9
    //p = 0x0012fed4; // using the value from my Watch window// task 10
    cout << "p = " << p << endl;
    // task 10
...
//     *cpcI = 7623;
    ...
    *pDyn = 17;
    ...
    delete pShrt;
    //delete pShrt;// the addresss change
    // task 26 :
...
// display all the Colours in the vector:
    ...
    public:
        ...
        bool movesInWith(Person& newRoomate) {
            // and now they do too
            if (roomie == nullptr && newRoomate.roomie == nullptr && newRoomate.roomie!= this) {
                roomie = &newRoomate;
